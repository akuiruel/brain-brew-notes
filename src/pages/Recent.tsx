  ...
  return (
    <Layout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold mb-1">Recently Viewed</h1>
          <p className="text-sm text-muted-foreground">
            Showing your {recentSheets.length} most recently viewed cheat sheet{recentSheets.length !== 1 ? 's' : ''}.
          </p>
        </div>
        ...
        {recentSheets.length === 0 ? (
          <div className="text-center py-12">
            <div className="text-muted-foreground">
              ...
              <p className="mb-4">View a cheat sheet to see it appear here.</p>
              <Link to="/">
